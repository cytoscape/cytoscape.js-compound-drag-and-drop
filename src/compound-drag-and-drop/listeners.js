...
const addListeners = function(){
  ...
  const canPullFromParent = n => isChild(n) || isParent(n);
  ...
  const addToCompoundDelayTime = options.addToCompoundDelayTime;
  const outFromCompoundDelayTime = options.outFromGroupDelayTime;
